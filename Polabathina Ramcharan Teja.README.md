...
> [!IMPORTANT]
> **GitHub Repository**: [https://github.com/ram/multi-agent-fraud-detection](https://github.com/ram/multi-agent-fraud-detection)
> For the best reading experience, interactive navigation, and to view the compiled Mermaid flowcharts and architecture diagrams clearly, please visit the GitHub repository.
...
![First Draft Architecture Diagram](docs/images/architecture_before.png)
...
![Refined Architecture Diagram](docs/images/architecture_after.png)
